...
If we have the higher order function \codeinline{map :: (a->b) -> [a] -> [b]} and the examples :: [Int] -> [Int], then our component function \codeinline{f} could have f::a->b, or f::Int->Int, or f::Int->a, but certainly not f::[Bool]->[Bool].
