...
This occurs when we try to use the first order function \texttt{negate::Int$\to$Int} as a component for \texttt{::a$\to$a} \markk{THIS SHOULD NEVER HAPPEN (I think), check code}.
