...
We evaluate an implementation of our tool against a large set of synthesis examples including lists, trees, maps, and specialized musical score data structures 
\end{abstract}
