...
\noindent In fact, solution1 is an application of the GHC\cite{ghc} implementation of concatMap. While it is correct and motivating to synthesize a solution using only the core higher order functions, a user would likely prefer to simply see \codeinline{concatMap} in the synthesized code.
