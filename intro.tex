...
In this work we only utilize the ability of refinement types to make judgements on the sizes input and output type, to be explained in more detail in Section \ref{HORtypeInf}.
...
For example, natural synthesis of the Boolean ``or'' function would return two function, \codeinline{any (id)} and \codeinline{foldr1 (max)}.
